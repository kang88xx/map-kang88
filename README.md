...
Render에서는 GitHub의 demo 브랜치로 Blueprint를 만들고 두 환경변수를 대시보드에 직접 등록합니다. Free Web Service는 유휴 상태에서 잠들어 첫 접속이 늦을 수 있으므로 실제 발표 전에는 서버를 미리 깨우거나 유료 인스턴스로 전환해야 합니다.
